...
export default function CharacterSection({ 
  ...
  // State for additional prompt input
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            <div style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}>
              ...
              <button
                type="button"
                className="ghost-btn"
                onClick={() => onAutoAnnotateCharacters(annotationMode, additionalPrompt)}
                disabled={!!autoAnnotateCharactersLoading}
            ...
            {(annotationMode === "supplement" || annotationMode === "modify") && (
              <input
                type="text"
